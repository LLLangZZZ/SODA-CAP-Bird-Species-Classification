...
This repository is a cleaned method-level release for the SODA-CAP Bird Species Classification paper. It is intended to document the core model and augmentation policy design, not to provide a complete reproduction package with data, trained weights, and cached predictions.
